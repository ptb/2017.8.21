...
# install_brew_bundle:3: no matches found: /Applications/Xcode*
# install_links:6: no matches found: /Applications/Xcode*
# mas_save before brew mas
# sed: 1: "1i /usr/local/node/shims": command i expects \ followed by text
# sed: 1: "1i /usr/local/perl/shims": command i expects \ followed by text
# sed: 1: "1i /usr/local/python/shims": command i expects \ followed by text
