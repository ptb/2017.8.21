...
#+begin_src sh :var _dest=_dest[3:10,1]
...
#+begin_src sh :var _args=_dest[4:9,0:1]
...
#+begin_example sh :var _built=_built[3:-2,0:1]
...
| homebrew/nginx/nginx-full | --with-dav-ext-module --with-fancyindex-module --with-gzip-static --with-http2 --with-mp4-h264-module --with-push-stream-module --with-secure-link --with-webdav                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
*** Customize Dock
#+begin_src sh :var _dock=_dock[3:-2,0]
...
#+begin_src sh :var _istat_menus=_istat_menus[3:-2,1:5]
...
| ~on~ *Enable* ~hexagon~ *grid with* ~10~ *×* ~6~ *cells*               | com.manytricks.Moom | Mouse Controls Grid                                   | -bool      | true                                                                    |      |
...
| ~off~ *Show on hover*                                                  | com.manytricks.Moom | Mouse Controls Include Custom Controls: Show On Hover | -bool      | true                                                                    |      |
...
| ~Move & Zoom~                                                          | com.manytricks.Moom | Custom Controls                                       | -array-add | { Action = 19; "Relative Frame" = "{{0, 0.33333}, {0.5, 0.66666}}"; }   |      |
...
| *Define window sizes using* ~10~ *×* ~6~ *cells*                       | com.manytricks.Moom | Configuration Grid: Columns                           | -int       | 10                                                                      |      |
